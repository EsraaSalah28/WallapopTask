...
import main.movestrategy.RoverMoveLeft;
...
class RoverMoveLeftTest {

    @Test
    void test_ValidMove_Left_PositionIsCorrect() {
        RoverPosition currentPosition = new RoverPosition(2, 2);
        Directions expectedDir = Directions.WEST;
        ...
        RoverMoveLeft roverMoveLeft = new RoverMoveLeft(roverSpy, mapSpace);
    ...
    void test_ShouldNotMove_WhenPositionIsOccupied() {
        ...
        RoverMoveLeft rover = new RoverMoveLeft(roverSpy,  mapSpace);
